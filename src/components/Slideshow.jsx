    ...
    >
      {slides.map((slide, index) => (
        ...
        >
          ...
          {/* text overlay */}
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center px-4 hover:bg-opacity-40 transition duration-300 z-20">
